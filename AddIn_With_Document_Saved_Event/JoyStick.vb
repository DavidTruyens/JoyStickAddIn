...
Public Class Joystick
    ...
    Private parent As Windows.Forms.Form  'Form1'
    Private Const MM_JOY1MOVE As Integer = &H3A0
    'Private Const MM_JOY2MOVE As Integer = &H3A1
    ...
    <StructLayout(LayoutKind.Explicit)> Private Structure JoyPosition
        <FieldOffset(0)> Public Raw As IntPtr
        <FieldOffset(0)> Public XPos As UShort
        <FieldOffset(2)> Public YPos As UShort
    End Structure
    ...
    Public Sub New(ByVal parent As Form, ByVal joyId As Integer)
        ...
        Me.parent = parent
        Dim result As Integer = NativeMethods.JoySetCapture(Me.Handle, joyId, 10, True)
    End Sub
    ...
    Protected Overrides Sub WndProc(ByRef m As System.Windows.Forms.Message)
        If m.Msg = MM_JOY1MOVE Then
            ...
            Else
                ...
                End If
            End If
            'Debug.Print("xpos: " & p.XPos & " ypos: " & p.YPos)
        End If
